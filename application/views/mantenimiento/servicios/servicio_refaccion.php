<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Catálogo de refacciones para servicio
            </h1>
        </section>
        ...
        <section class="content">
                    ...
                    <div style="float: right; margin-bottom: 15px">
                        <div class="btn-group">
                            <button type="button" id="agregar-mecanico" class="btn btn-block btn-success"
                                ...
                                <i class="fa fa-fw fa-plus"></i> Agregar refacciones para servicio
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade bs-example-modal-lg" id="myModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="form-servicio-refaccion">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="piezas"
                                                           placeholder="Piezas" name="piezas">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        Lista de refacciones para servicio: <?= $servicio->nombre ?>
                    </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table data-id="<?= $servicio->id ?>" id="example1" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Descripcion</th>
